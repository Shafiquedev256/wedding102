...
export default function Hero() {
  ...
  return (
    <>
      ...
      <div className='relative min-h-screen text-white md:h-screen bg-[#f2eee2] flex flex-col'>
        {/* Navigation */}
        <nav
        ...
        <div className='flex flex-1 flex-col items-center justify-center px-6 text-center'>
          <div className='max-w-4xl w-full space-y-6 md:space-y-8'>
            ...
            <div className='flex justify-center items-center'>
              <img
                src='/herosection_wedding-removebg-preview.png'
                alt='Gemma and Jede Wedding Invitation'
                className=' object-contain md:w-[1000px]'
              />
            </div>

            <div className='p-2 md:pb-2 pb-2 md:mb-18 h- md:mt-0 md:pt-2 pt-6 md:h-20'></div>
