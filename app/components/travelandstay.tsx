  ...
  return (
    ...
    >
      <div className='max-w-6xl mx-auto'>
        ...
        {/* Neighborhoods */}
        <div className='mb-2 text-center flex flex-col justify-center items-center px-8'>
        ...
        <div className='mb-16 max-w-3xl mx-auto'>
          <div className=' py-2 px-8 pb-3 max-w-3xl mx-auto  w-full'>
        ...
        <div className='bg-[#FDF8F5] backdrop-blur-sm max-w-3xl mx-auto     mb-16'>
          <div className=''>
            <div className='space-y-6 p-6'>
              <div>
                <div className='flex  mb-4 pb-4 border-b border-gray-200 flex-row space-x-5 justify-between items-center'>
                  <div className='mb-4'>
                  ...
                  <div>
                    <a
                      ...
                      target='_blank'
                      rel='noopener noreferrer'
                      className='bg-gradient-to-br from-[#7D2E3D] to-[#7D2E3D] whitespace-nowrap p-2 text-white flex items-center justify-center gap-2 hover:scale-105 transition-all'
                    >
                ...
                <div className='flex  mb-4 pb-4  flex-row space-x-5 justify-between items-center'>
                  <div className='mb-4'>
